...
impl Network {
    ...
    pub fn from_magic(magic: u32) -> Option<Network> {
        ...
        match magic {
            0xDDB7D9FC => Some(Network::Bitcoin),
            0xDBB8C0FB => Some(Network::Testnet),
            0xDCB7C1FC => Some(Network::Signet),
    ...
    pub fn magic(self) -> u32 {
        ...
        match self {
            Network::Bitcoin => 0xDDB7D9FC,
            Network::Testnet => 0xDBB8C0FB,
            Network::Signet  => 0xDCB7C1FC,
